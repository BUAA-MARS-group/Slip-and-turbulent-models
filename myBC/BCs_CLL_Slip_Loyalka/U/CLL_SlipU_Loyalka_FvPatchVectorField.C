...
#include "CLL_SlipU_Loyalka_FvPatchVectorField.H"
...
Foam::CLL_SlipU_Loyalka_FvPatchVectorField::CLL_SlipU_Loyalka_FvPatchVectorField
(
    const fvPatch& p,
...
Foam::CLL_SlipU_Loyalka_FvPatchVectorField::CLL_SlipU_Loyalka_FvPatchVectorField
(
    const CLL_SlipU_Loyalka_FvPatchVectorField& mspvf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
void Foam::CLL_SlipU_Loyalka_FvPatchVectorField::autoMap
(
...
void Foam::CLL_SlipU_Loyalka_FvPatchVectorField::rmap
(
...
)
{
    ...
    const CLL_SlipU_Loyalka_FvPatchVectorField& mspvf =
        refCast<const CLL_SlipU_Loyalka_FvPatchVectorField>(pvf);

    Uwall_.rmap(mspvf.Uwall_, addr);
}


void Foam::CLL_SlipU_Loyalka_FvPatchVectorField::reset
(
    const fvPatchVectorField& pvf
)
{
...
void Foam::CLL_SlipU_Loyalka_FvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    (
      ...
      * (
        (2.0 - accommodationCoeff_t_)/accommodationCoeff_t_ * (1.0 + (4.0 - Foam::constant::mathematical::pi) / (2.0 * Foam::constant::mathematical::pi) * accommodationCoeff_t_)
        - (4.0 - Foam::constant::mathematical::pi) / (2.0 * Foam::constant::mathematical::pi) * accommodationCoeff_n_ * (1.0 - accommodationCoeff_t_)
        )
    );
...
void Foam::CLL_SlipU_Loyalka_FvPatchVectorField::write(Ostream& os) const
{
...
namespace Foam
{
    ...
    (
        fvPatchVectorField,
        CLL_SlipU_Loyalka_FvPatchVectorField
    );
}
