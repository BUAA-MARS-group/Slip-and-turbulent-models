...
#include "CLL_JumpT_Loyalka_FvPatchScalarField.H"
...
Foam::CLL_JumpT_Loyalka_FvPatchScalarField::CLL_JumpT_Loyalka_FvPatchScalarField
(
    const fvPatch& p,
...
Foam::CLL_JumpT_Loyalka_FvPatchScalarField::CLL_JumpT_Loyalka_FvPatchScalarField
(
    const CLL_JumpT_Loyalka_FvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::CLL_JumpT_Loyalka_FvPatchScalarField::CLL_JumpT_Loyalka_FvPatchScalarField
(
    const CLL_JumpT_Loyalka_FvPatchScalarField& ptpsf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void Foam::CLL_JumpT_Loyalka_FvPatchScalarField::autoMap
(
...
void Foam::CLL_JumpT_Loyalka_FvPatchScalarField::rmap
(
...
)
{
    ...
    const CLL_JumpT_Loyalka_FvPatchScalarField& ptpsf =
        refCast<const CLL_JumpT_Loyalka_FvPatchScalarField>(ptf);

    Twall_.rmap(ptpsf.Twall_, addr);
}


void Foam::CLL_JumpT_Loyalka_FvPatchScalarField::reset
(
    const fvPatchField<scalar>& ptf
)
{
...
void Foam::CLL_JumpT_Loyalka_FvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    (
        ...
        *(1.0-(2.0*accommodationCoeff_t_*(2.0-accommodationCoeff_t_)+3.0*accommodationCoeff_n_)/10.0)
        +2.0/5.0*2.0/(5.0*Foam::constant::mathematical::pi)*(26.0-4.0*accommodationCoeff_t_*(2.0-accommodationCoeff_t_)-9.0*accommodationCoeff_n_)
        +2.0/5.0*2.0/(5.0*Foam::constant::mathematical::pi)*(Foam::constant::mathematical::pi-4)*accommodationCoeff_n_*(1.0-accommodationCoeff_t_*(2.0-accommodationCoeff_t_))
        )
    );
...
void Foam::CLL_JumpT_Loyalka_FvPatchScalarField::write(Ostream& os) const
{
...
namespace Foam
{
    ...
    (
        fvPatchScalarField,
        CLL_JumpT_Loyalka_FvPatchScalarField
    );
}
